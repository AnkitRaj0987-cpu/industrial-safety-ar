    ...
    public sealed class LocaleService
    {
        ...
        private void PopulateCatalog()
        {
            ...
            var en = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                { "welcome_back_format", "Welcome back, {0}" },
                ...
                { "btn_continue_training", "CONTINUE TRAINING →" },
                { "nav_home", "HOME" },
                { "nav_ar", "AR" },
                { "nav_records", "RECORDS" },
                ...
                { "ar_screen_title", "AR SAFETY TRAINING" },
                { "ar_screen_subtitle", "Interactive Industrial Safety Training" },
                { "ar_screen_desc", "Use your phone camera to enter an interactive safety scenario." },
                { "ar_camera_inactive", "Camera is currently inactive." },
                { "ar_camera_active", "AR Camera is active. Look for floor surfaces." },
                { "btn_enable_ar", "ENABLE AR CAMERA" },
                { "btn_exit_ar", "EXIT AR" },
                { "camera_permission_required", "Camera permission is required for AR training." },
                { "btn_open_settings", "OPEN SETTINGS" },
                { "btn_allow_camera", "ALLOW CAMERA" },
                { "status_online", "ONLINE" },
                { "status_offline", "OFFLINE" },
                { "status_sync_ready", "SYNC READY" },
                { "status_saved_locally", "SAVED LOCALLY" },
                { "certificates_title", "Certificates" },
                { "certificates_empty_desc", "Training certificates will appear here after successful training and synchronization." },
                { "certificates_empty_sub", "No official certificates issued yet." },
                ...
                { "ppe_title", "PPE SELECTION & PREPARATION" },
                { "ppe_unsafe_warning", "ATMOSPHERE: UNSAFE. PPE DOES NOT MAKE AN UNSAFE ATMOSPHERE SAFE. DO NOT ENTER." },
                { "ppe_item_helmet", "Safety Helmet" },
                { "ppe_item_harness", "Full-Body Harness" },
                { "ppe_item_gloves", "Protective Gloves" },
                { "ppe_item_boots", "Safety Boots" },
                { "ppe_item_scba", "SCBA (Breathing Apparatus)" },
                { "ppe_item_dust_mask", "Dust Mask (Invalid)" },
                { "ppe_item_surgical_mask", "Surgical Mask (Invalid)" },
                { "ppe_btn_confirm", "CONFIRM PPE SELECTION" },
                { "verify_title", "PPE INSPECTION & VERIFICATION" },
                { "verify_warning", "Equipment verification confirms readiness; it does NOT make an unsafe atmosphere safe." },
                { "verify_scba_seal", "Verify SCBA Seal" },
                { "verify_harness_fit", "Verify Harness Fit" },
                { "verify_cylinder_pressure", "Check Cylinder Pressure" },
                { "verify_btn_action", "VERIFY" },
                { "verify_status_ok", "VERIFIED ✓" },
                { "attendant_title", "BUDDY / OUTSIDE ATTENDANT SYSTEM" },
                { "attendant_outside", "Outside Confined Space" },
                { "attendant_rule", "The attendant MUST remain OUTSIDE the confined space hazard area at all times." },
                { "attendant_btn_assign", "ASSIGN OUTSIDE ATTENDANT" },
                { "attendant_status_assigned", "ATTENDANT ASSIGNED (OUTSIDE) ✓" },
                { "comm_title", "TWO-WAY RADIO COMMUNICATION" },
                { "comm_radio", "Intrinsically Safe Radio" },
                { "comm_btn_check", "CHECK COMMUNICATION" },
                { "comm_status_verified", "COMMUNICATION VERIFIED ✓" },
                { "comm_worker_radio", "Worker Radio" },
            ...
            var hi = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                { "welcome_back_format", "वापसी पर स्वागत है, {0}" },
                ...
                { "btn_continue_training", "प्रशिक्षण जारी रखें →" },
                { "nav_home", "होम" },
                { "nav_ar", "एआर" },
                { "nav_records", "रिकॉर्ड" },
                ...
                { "ar_screen_title", "एआर सुरक्षा प्रशिक्षण" },
                { "ar_screen_subtitle", "इंटरैक्टिव औद्योगिक सुरक्षा प्रशिक्षण" },
                { "ar_screen_desc", "इंटरैक्टिव सुरक्षा परिदृश्य में प्रवेश करने के लिए अपने फोन कैमरे का उपयोग करें।" },
                { "ar_camera_inactive", "कैमरा वर्तमान में निष्क्रिय है।" },
                { "ar_camera_active", "एआर कैमरा सक्रिय है। फर्श की सतह देखें।" },
                { "btn_enable_ar", "एआर कैमरा चालू करें" },
                { "btn_exit_ar", "एआर से बाहर निकलें" },
                { "camera_permission_required", "एआर प्रशिक्षण के लिए कैमरा अनुमति आवश्यक है।" },
                { "btn_open_settings", "सेटिंग्स खोलें" },
                { "btn_allow_camera", "कैमरा अनुमति दें" },
                { "status_online", "ऑनलाइन" },
                { "status_offline", "ऑफ़लाइन" },
                { "status_sync_ready", "सिंक तैयार" },
                { "status_saved_locally", "स्थानीय रूप से सहेजा गया" },
                { "certificates_title", "प्रमाणपत्र" },
                { "certificates_empty_desc", "सफल प्रशिक्षण और सिंक के बाद प्रशिक्षण प्रमाणपत्र यहाँ दिखाई देंगे।" },
                { "certificates_empty_sub", "अभी तक कोई आधिकारिक प्रमाणपत्र जारी नहीं किया गया है।" },
                ...
                { "detector_locked", "बंद" },
                { "ppe_title", "पीपीई चयन एवं तैयारी" },
                { "ppe_unsafe_warning", "वायुमंडल: असुरक्षित। पीपीई असुरक्षित वातावरण को सुरक्षित नहीं बनाता। प्रवेश न करें।" },
                { "ppe_item_helmet", "सुरक्षा हेलमेट" },
                { "ppe_item_harness", "फुल-बॉडी हार्ネス" },
                { "ppe_item_gloves", "सुरक्षा दस्ताने" },
                { "ppe_item_boots", "सुरक्षा जूते" },
                { "ppe_item_scba", "एससीबीए (श्वसन उपकरण)" },
                { "ppe_item_dust_mask", "डस्ट मास्क (अमान्य)" },
                { "ppe_item_surgical_mask", "सर्जिकल मास्क (अमान्य)" },
                { "ppe_btn_confirm", "पीपीई चयन की पुष्टि करें" },
                { "verify_title", "पीपीई निरीक्षण एवं सत्यापन" },
                { "verify_warning", "उपकरण सत्यापन तत्परता की पुष्टि करता है; यह असुरक्षित वातावरण में प्रवेश की अनुमति नहीं देता।" },
                { "verify_scba_seal", "एससीबीए सील जांचें" },
                { "verify_harness_fit", "हार्नेस फिटिंग जांचें" },
                { "verify_cylinder_pressure", "सिलेंडर दबाव जांचें" },
                { "verify_btn_action", "जांचें" },
                { "verify_status_ok", "सत्यापित ✓" },
                { "attendant_title", "बडी / बाहरी परिचारक प्रणाली" },
                { "attendant_outside", "सीमित स्थान से बाहर" },
                { "attendant_rule", "परिचारक को हर समय सीमित स्थान के खतरे वाले क्षेत्र से बाहर रहना चाहिए।" },
                { "attendant_btn_assign", "बाहरी परिचारक नियुक्त करें" },
                { "attendant_status_assigned", "परिचारक नियुक्त (बाहर) ✓" },
                { "comm_title", "द्वि-मार्गी रेडियो संचार" },
                { "comm_radio", "सुरक्षित रेडियो" },
                { "comm_btn_check", "संचार जांचें" },
                { "comm_status_verified", "रेडियो संचार सत्यापित ✓" },
                { "comm_worker_radio", "श्रमिक रेडियो" },
            ...
            var sat = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                { "welcome_back_format", "ᱥᱟᱹᱜᱩᱱ ᱫᱟᱨᱟᱢ, {0}" },
                { "safety_training", "ᱨᱩᱠᱷᱤᱭᱟᱹ ᱴᱨᱮᱱᱤᱝ" },
                ...
                { "status_in_progress", "ᱪᱟᱞᱟᱜ ᱠᱟᱱᱟ" },
                { "status_completed", "ᱯᱩᱨᱟᱹᱣ ᱮᱱᱟ" },
                { "status_coming_soon", "ᱞᱚᱜᱚᱱ ᱦᱤᱡᱩᱜ-ᱟ" },
                { "available_offline", "ᱚᱯᱷᱞᱟᱭᱤᱱ ᱢᱮᱱᱟᱜᱼᱟ" },
                { "btn_start_training", "ᱴᱨᱮᱱᱤᱝ ᱮᱦᱚᱵ ᱢᱮ →" },
                { "btn_continue_training", "ᱴᱨᱮᱱᱤᱝ ᱞᱟᱦᱟᱭ ᱢᱮ →" },
                { "nav_home", "ᱳᱲᱟᱜ" },
                { "nav_ar", "ᱮ.ᱟᱨ" },
                { "nav_records", "ᱨᱮᱠᱚᱨᱰ" },
                { "nav_certificates", "ᱥᱟᱠᱟᱢ" },
                { "nav_profile", "ᱯᱨᱚᱯᱷᱟᱭᱤᱞ" },
                { "btn_logout", "ᱞᱚᱜᱽ ᱟᱣᱩᱴ" },
                { "btn_login", "ᱞᱚᱜᱽ ᱤᱱ" },
                { "btn_sync_now", "ᱥᱤᱝᱠ ᱢᱮ" },
                { "ar_screen_title", "ᱮ.ᱟᱨ ᱨᱩᱠᱷᱤᱭᱟᱹ ᱥᱮᱪᱮᱫ" },
                { "ar_screen_subtitle", "ᱤᱱᱴᱟᱨᱮᱠᱴᱤᱵᱷ ᱠᱟᱹᱨᱜᱟᱲ ᱨᱩᱠᱷᱤᱭᱟᱹ ᱥᱮᱪᱮᱫ" },
                { "ar_screen_desc", "ᱢᱤᱫ ᱤᱱᱴᱟᱨᱮᱠᱴᱤᱵᱷ ᱨᱩᱠᱷᱤᱭᱟᱹ ᱴᱷᱟᱶ ᱨᱮ ᱵᱚᱞᱚᱱ ᱞᱟᱹᱜᱤᱫ ᱟᱢᱟᱜ ᱯᱷᱚᱱ ᱠᱮᱢᱮᱨᱟ ᱵᱮᱵᱷᱟᱨ ᱢᱮ᱾" },
                { "ar_camera_inactive", "ᱠᱮᱢᱮᱨᱟ ᱱᱤᱛᱚᱜ ᱵᱚᱸᱫᱽ ᱜᱮᱭᱟ᱾" },
                { "ar_camera_active", "ᱮ.ᱟᱨ ᱠᱮᱢᱮᱨᱟ ᱮᱦᱚᱵ ᱟᱠᱟᱱᱟ᱾ ᱚᱛ ᱨᱮᱱᱟᱜ ᱪᱮᱛᱟᱱ ᱧᱮᱞ ᱢᱮ᱾" },
                { "btn_enable_ar", "ᱮ.ᱟᱨ ᱠᱮᱢᱮᱨᱟ ᱮᱦᱚᱵ ᱢᱮ" },
                { "btn_exit_ar", "ᱮ.ᱟᱨ ᱠᱷᱚᱱ ᱚᱰᱚᱠᱚᱜ ᱢᱮ" },
                { "camera_permission_required", "ᱮ.ᱟᱨ ᱥᱮᱪᱮᱫ ᱞᱟᱹᱜᱤᱫ ᱠᱮᱢᱮᱨᱟ ᱪᱷᱟᱹᱲ ᱞᱟᱹᱠᱛᱤ ᱜᱮᱭᱟ᱾" },
                { "btn_open_settings", "ᱥᱮᱴᱤᱝᱥ ᱠᱷᱩᱞᱟᱹᱭ ᱢᱮ" },
                { "btn_allow_camera", "ᱠᱮᱢᱮᱨᱟ ᱪᱷᱟᱹᱲ ᱮᱢ ᱢᱮ" },
                { "status_online", "ᱚᱱᱞᱟᱭᱤᱱ" },
                { "status_offline", "ᱚᱯᱷᱞᱟᱭᱤᱱ" },
                { "status_sync_ready", "ᱥᱤᱝᱠ ᱛᱮᱭᱟᱨ" },
                { "status_saved_locally", "ᱱᱚᱸᱰᱮ ᱥᱟᱧᱪᱟᱣ ᱟᱠᱟᱱᱟ" },
                { "certificates_title", "ᱥᱟᱠᱟᱢ (Certificates)" },
                { "certificates_empty_desc", "ᱥᱟᱹᱛ ᱴᱨᱮᱱᱤᱝ ᱟᱨ ᱥᱤᱝᱠ ᱛᱟᱭᱚᱢ ᱥᱟᱨᱴᱤᱯᱷᱤᱠᱮᱴ ᱱᱚᱸᱰᱮ ᱧᱮᱞᱚᱜᱼᱟ᱾" },
                { "certificates_empty_sub", "ᱱᱤᱛ ᱫᱷᱟᱹᱵᱤᱡ ᱥᱟᱨᱴᱤᱯᱷᱤᱠᱮᱴ ᱵᱟᱝ ᱮᱢ ᱟᱠᱟᱱᱟ᱾" },
                { "preferred_language_label", "ᱠᱩᱥᱤᱭᱟᱜ ᱯᱟᱹᱨᱥᱤ" },
                { "badge_ar", "AR" },
                ...
                { "ppe_title", "ᱯᱤ.ᱯᱤ.ᱤ. ᱵᱟᱪᱷᱟᱣ ᱟᱨ ᱥᱟᱯᱲᱟᱣ" },
                { "ppe_unsafe_warning", "ᱦᱚᱭ-ᱦᱤᱥᱤᱫ: ᱵᱚᱛᱚᱨᱟᱱ ᱾ ᱯᱤ.ᱯᱤ.ᱤ. ᱫᱚ ᱵᱚᱛᱚᱨᱟᱱ ᱦᱚᱭ-ᱦᱤᱥᱤᱫ ᱵᱟᱭ ᱵᱮᱥᱟ ᱾ ᱟᱞᱚᱢ ᱵᱚᱞᱚᱱᱟ ᱾" },
                { "ppe_item_helmet", "ᱨᱩᱠᱷᱤᱭᱟᱹ ᱦᱮᱞᱢᱮᱴ" },
                { "ppe_item_harness", "ᱯᱩᱨᱟᱹ-ᱦᱚᱲᱢᱚ ᱦᱟᱨᱱᱮᱥ" },
                { "ppe_item_gloves", "ᱨᱩᱠᱷᱤᱭᱟᱹ ᱛᱤ ᱢᱚᱡᱟ" },
                { "ppe_item_boots", "ᱨᱩᱠᱷᱤᱭᱟᱹ ᱡᱩᱛᱟᱹ" },
                { "ppe_item_scba", "ᱮᱥ.ᱥᱤ.ᱵᱤ.ᱮ. (ᱥᱟᱦᱮᱫ ᱥᱟᱯᱟᱵ)" },
                { "ppe_item_dust_mask", "ᱫᱷᱩᱲᱤ ᱢᱩᱠᱷᱚᱥ (ᱵᱟᱹᱲᱤᱡ)" },
                { "ppe_item_surgical_mask", "ᱥᱟᱨᱡᱤᱠᱟᱞ ᱢᱩᱠᱷᱚᱥ (ᱵᱟᱹᱲᱤᱡ)" },
                { "ppe_btn_confirm", "ᱯᱤ.ᱯᱤ.ᱤ. ᱵᱟᱪᱷᱟᱣ ᱴᱷᱟᱹᱣᱠᱟᱹᱭ ᱢᱮ" },
                { "verify_title", "ᱯᱤ.ᱯᱤ.ᱤ. ᱧᱮᱞ-ᱵᱤᱰᱟᱹᱣ ᱟᱨ ᱯᱩᱥᱴᱟᱹᱣ" },
                { "verify_warning", "ᱥᱟᱯᱟᱵ ᱯᱩᱥᱴᱟᱹᱣ ᱫᱚ ᱛᱮᱭᱟᱨ ᱮ ᱯᱩᱥᱴᱟᱹᱣᱟ; ᱱᱚᱣᱟ ᱫᱚ ᱵᱚᱛᱚᱨᱟᱱ ᱦᱚᱭ-ᱦᱤᱥᱤᱫ ᱨᱮ ᱵᱚᱞᱚᱱ ᱨᱮᱭᱟᱜ ᱪᱷᱟᱹᱲ ᱵᱟᱭ ᱮᱢᱟ ᱾" },
                { "verify_scba_seal", "ᱮᱥ.ᱥᱤ.ᱵᱤ.ᱮ. ᱥᱤᱞ ᱯᱚᱨᱚᱠ" },
                { "verify_harness_fit", "ᱦᱟᱨᱱᱮᱥ ᱯᱷᱤᱴ ᱯᱚᱨᱚᱠ" },
                { "verify_cylinder_pressure", "ᱥᱤᱞᱤᱱᱰᱚᱨ ᱪᱟᱯ ᱯᱚᱨᱚᱠ" },
                { "verify_btn_action", "ᱯᱚᱨᱚᱠ" },
                { "verify_status_ok", "ᱯᱩᱥᱴᱟᱹᱣ ᱮᱱᱟ ✓" },
                { "attendant_title", "ᱜᱟᱛᱮ / ᱵᱟᱦᱨᱮ ᱮᱴᱮᱱᱰᱮᱱᱴ ᱵᱮᱵᱚᱥᱛᱷᱟ" },
                { "attendant_outside", "ᱵᱚᱛᱚᱨᱟᱱ ᱴᱷᱟᱶ ᱠᱷᱚᱱ ᱵᱟᱦᱨᱮ" },
                { "attendant_rule", "ᱨᱩᱠᱷᱤᱭᱟᱹ ᱮᱴᱮᱱᱰᱮᱱᱴ ᱫᱚ ᱡᱟᱣᱜᱮ ᱵᱚᱛᱚᱨᱟᱱ ᱴᱷᱟᱶ ᱠᱷᱚᱱ ᱵᱟᱦᱨᱮ ᱨᱮᱜᱮ ᱛᱟᱦᱮᱸᱱ ᱞᱟᱹᱠᱛᱤ ᱾" },
                { "attendant_btn_assign", "ᱵᱟᱦᱨᱮ ᱮᱴᱮᱱᱰᱮᱱᱴ ᱵᱟᱦᱟᱞ ᱢᱮ" },
                { "attendant_status_assigned", "ᱮᱴᱮᱱᱰᱮᱱᱴ ᱵᱟᱦᱟᱞ ᱮᱱᱟ (ᱵᱟᱦᱨᱮ) ✓" },
                { "comm_title", "ᱵᱟᱨ-ᱥᱮᱦᱮᱫ ᱨᱮᱰᱤᱭᱳ ᱡᱚᱯᱚᱲᱟᱣ" },
                { "comm_radio", "ᱨᱩᱠᱷᱤᱭᱟᱹ ᱨᱮᱰᱤᱭᱳ" },
                { "comm_btn_check", "ᱡᱚᱯᱚᱲᱟᱣ ᱯᱚᱨᱚᱠ ᱢᱮ" },
                { "comm_status_verified", "ᱨᱮᱰᱤᱭᱳ ᱡᱚᱯᱚᱲᱟᱣ ᱯᱩᱥᱴᱟᱹᱣ ᱮᱱᱟ ✓" },
                { "comm_worker_radio", "ᱠᱟᱹᱢᱤᱭᱟᱹ ᱨᱮᱰᱤᱭᱳ" },
